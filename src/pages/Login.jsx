...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.isSuccess) {
        ...
        localStorage.setItem("rahasia punya imam", "aku bangga bgt sama kalian FSW2 !");
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      {notification && <Notification type={notification.type} message={notification.message} description={notification.description} onClose={() => setNotification(null)} />}
